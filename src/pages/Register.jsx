              ...
              <div className="row">
                ...
                <div className="col-md-6">
                  <div className="input-div mt-2">
                    ...
                    <input className="input-filed" type='password' placeholder="Enter Your password" name="password" value={password} onChange={(e) => { setPassword(e.target.value) }} /> <br></br>
                  </div>
                  <div className="input-div mt-2">
                ...
                <div className="col-md-6">
                  ...
                  <div className="input-div mt-2">
                    ...
                    <input className="input-filed" type='text' placeholder="Enter Your skills" name="interestedJob" value={skills} onChange={(e) => { setSkill(e.target.value) }} /> <br></br>
                  </div>
                ...
                <div className="col-md-6">
                  <div className="input-div mt-2">
                    ...
                    <input className="input-filed" type='text' placeholder="Enter Your education" name="interestedJob" value={education} onChange={(e) => { setEducation(e.target.value) }} /> <br></br>
                  </div>
                  <div className="input-div mt-2">

                    <input className="input-filed" type='text' placeholder="Enter Your experience" name="interestedJob" value={experience} onChange={(e) => { setExperience(e.target.value) }} /> <br></br>
                  </div>
                ...
                <div className="input-div mt-2">
                  ...
                  <input className="input-filed" type='text' placeholder="Enter Your hobbies" name="interestedJob" value={hobbies} onChange={(e) => { setHobbile(e.target.value) }} /> <br></br>
                </div>
